      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
                  ...
                  <li class="nav-item d-none"><a class="nav-link <?=(!empty($action) ? 'active' : '')?>" href="#addschedule" data-toggle="tab">Assign worker class schedule</a></li>
            ...
            <div class="tab-content">
                        ...
                        <label for="centersOption">Center</label>
                          ...
                          <?php foreach ($centers as $key => $value): ?>
                            <option value="<?=$value->centerName?>"><?=$value->centerName?></option>
                          <?php endforeach ?>
                            </select>
                                ...
                                <div class="col-md-9">
                                  ...
                                  <input type="search" id="search_worker" name="searchstring" placeholder="Search here..." class="form-control">
                                </div>
                              </div>
                ...
                <h4 class="table-title text-title">List all workers</h4>
                  ...
                  <div class="col-md-4" style="text-align: right;"><button class="btn  btn-md btn-success" id="btn-excel-worker">Export to excel</button></div>
                </div>
                <table id="worker-table" class="table table-bordered table-striped w-100">
                  <thead>
                  <tr>
                    <th>#</th>
                    <th>Name</th>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <select name="jobStatus" id="jobStatus" class="form-control" >
                      ...
                      <option value="4">Resigned</option>
                      <option value="5">Retired</option>
                      <option value="6">End Contract</option>
                    </select>
                    <?=form_error('jobStatus')?>
                  </div>                  
                </div>
