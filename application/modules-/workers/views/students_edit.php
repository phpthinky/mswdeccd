 ...
 <span>Parent Details</span>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <div class="col-sm-12 col-md-10">
                           <div class="row">
                            <div class="col-xs-12 col-md-4"><input type="text" class="form-control" name="f_fName" id="e_f_fName" placeholder="First Name" value="" /></div>
                            <div class="col-xs-12 col-md-1"><input type="text" class="form-control" name="f_mName"  id="e_f_mName" placeholder="Mi." value=""/></div>
                            <div class="col-xs-12 col-md-4"><input type="text" class="form-control" name="f_lName"  id="e_f_lName" placeholder="Last Name" value="" /></div>
                            
                            <div class="col-xs-12 col-md-3"><input type="text" name="f_ext"  id="e_f_ext"  value="" class="form-control" placeholder="Extension: Jr." width="50px"></div>
                            </div>
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          ...
                          <div class="col-sm-12 col-md-10">
                           <div class="row">
                            <div class="col-xs-12 col-md-4"><input type="text" class="form-control" name="m_fName"  id="e_m_fName"  placeholder="First Name" value="" /></div>
                            <div class="col-xs-12 col-md-1"><input type="text" class="form-control" name="m_mName"  id="e_m_mName" placeholder="Mi." value=""/></div>
                            <div class="col-xs-12 col-md-4"><input type="text" class="form-control" name="m_lName" id="e_m_lName"  placeholder="Last Name" value="" /></div>
                            
                            <div class="col-xs-12 col-md-3"><input type="text" name="m_ext"  id="e_m_ext"  value="" class="form-control" placeholder="Extension: Jr." width="50px"></div>
                            </div>
                        </div>
