                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <a class="btn btn-default" style="cursor:pointer;">Parent details...</a>
                     <p><b>Father</b> <span><?=$f_fName?></span> <span><?=$f_mName?></span> <span><?=$f_lName?></span> <span><?=$f_ext?></span></p>
                    <p><b>Mother</b>
                      <span><?=$m_fName?></span> <span><?=$m_mName?></span> <span><?=$m_lName?></span> <span><?=$m_ext?></span></p>
                  </li>
                </ul>
