...
<head>
  ...
  <title>MSWD ECCD | Nutricare</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: forestgreen !important;">
    ...
    <a href="<?=site_url()?>" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Nutricare</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Admi N Istrator</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=site_url('nutricare')?>" class="nav-link active-out">
          ...
          <li class="nav-item">
            <a href="<?=site_url('nutricare/pupils')?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?=site_url('nutricare/workers')?>" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Daycare Worker
              </p>
          ...
          <li class="nav-item">
            <a href="<?=site_url('nutricare/center')?>" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Daycare Center
              </p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?=site_url('nutricare-weighing')?>" class="nav-link">
