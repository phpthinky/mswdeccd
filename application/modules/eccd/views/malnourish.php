<main class="content-wrapper">
	...
	<section class="content-header">
		<a class="btn btn-md btn-default" href="<?=site_url('eccd/listallnormal')?>">Normal</a>
		<a class="btn btn-md btn-primary"  href="<?=site_url('eccd/listallmalnourish')?>">Malnourish</a>
    ...
    <label>MSWD ECCD RECORDS</label>
				...
				<div class="col-md-12">
    <label>LIST OF PUPILS WITH MALNUTRITIONS</label>
