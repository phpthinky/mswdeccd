                      ...
                      <?php foreach ($myschoolyear as $key => $row): ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="<?=site_url('workers/my_students/'.$worker_id.'/'.$row->year_id)?>" title="View students" class="btn btn-default btn-sm"><i class="fa fa-list"></i></a> <button title="Delete from my list" class="btn btn-default btn-sm"><i class="fa fa-trash"></i></button>
                            <?php endif ?>
                          </td>
                        </tr>
                      <?php endforeach ?>
