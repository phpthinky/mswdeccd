            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#tab-assessment" data-toggle="tab">Assessment</a></li>
              ...
              <div class="card-body">
                    ...
                    <div class="card" id="cardWeight"> 
                      ...
                      <div class="card-body">
                        ...
                        <div class="row">
                          ...
                          <select class="form-control home-class-schedule" name="class_schedule" id="home-classess">
                ...
                <table id="tblmystudents" class="table table-bordered w-100">
                  ...
                  <div class="tab-pane" id="tab-assessment">
                    <!-- The timeline -->
                    <?php $this->load->view('workers/assessments.php'); ?>
